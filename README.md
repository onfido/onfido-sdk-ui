...
Face capture uses the webcam by default for capturing live photos of users. File upload is supported as a fallback on desktop and large screen. On mobile users must use the phone camera to capture live photos.
...
[JsFiddle example here.](https://jsfiddle.net/4xqtt6fL/1233/)
