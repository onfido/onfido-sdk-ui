...
class PoaDocumentSelection extends BasePage {
  async bankIcon() { return this.$('.onfido-sdk-ui-DocumentSelector-icon-bank-building-society-statement')}
  async bankLabel() { return this.$('li:nth-child(1) .onfido-sdk-ui-DocumentSelector-label')}
  async bankTag() { return this.$('li:nth-child(1) .onfido-sdk-ui-DocumentSelector-tag')}
  async utilityBillIcon() { return this.$('.onfido-sdk-ui-DocumentSelector-icon-utility-bill')}
  async utilityBillLabel() { return this.$('li:nth-child(2) .onfido-sdk-ui-DocumentSelector-label')}
  async utilityBillHint() { return this.$('li:nth-child(2) .onfido-sdk-ui-DocumentSelector-hint')}
  async utilityBillWarning() { return this.$('.onfido-sdk-ui-DocumentSelector-warning')}
  async utilityBillTag() { return this.$('li:nth-child(2) .onfido-sdk-ui-DocumentSelector-tag')}
  async councilTaxLetterIcon() { return this.$('li:nth-child(3) .onfido-sdk-ui-DocumentSelector-icon')}
  async councilTaxLetterLabel() { return this.$('li:nth-child(3) .onfido-sdk-ui-DocumentSelector-label')}
  async benefitsLetterIcon() { return this.$('li:nth-child(4) .onfido-sdk-ui-DocumentSelector-icon')}
  async benefitsLetterLabel() { return this.$('li:nth-child(4) .onfido-sdk-ui-DocumentSelector-label')}
  async benefitsLetterHint() { return this.$('li:nth-child(4) .onfido-sdk-ui-DocumentSelector-hint')}
