...
Feature: SDK File Upload Tests
  ...
  Scenario Outline: I should be able to upload a passport and an image of a face correctly.
    ...
    Then page_title should include "capture.face.upload_title"
  ...
  Scenario Outline: I should be able to upload a two-sided identity document and an image of a face correctly.
    ...
    Then page_title should include "capture.national_identity_card.back.title"
  ...
  Scenario Outline: I should be able to upload a two-sided driving license and an image of a face correctly.
    ...
    Then page_title should include "capture.driving_licence.back.title"
  ...
  Scenario Outline: I should not be able to upload a document which is clearly not a passport.
    ...
    Then error_message should include "errors.invalid_capture.message"
    And error_instruction should include "errors.invalid_capture.instruction"
  ...
  Scenario: I should not be able to upload a document over 10MB.
    ...
    Then upload_error_message should include "errors.invalid_size.message"
  ...
  Scenario: I should not be able to upload an unsupported type image of a face
    ...
    And error_message should include "errors.unsupported_file.message"
    And error_instruction should include "errors.unsupported_file.instruction"
  ...
  Scenario: I should not be able to upload an image containing multiple faces
    ...
    And error_message should include "errors.multiple_faces.message"
    And error_instruction should include "errors.multiple_faces.instruction"
  ...
  Scenario: I should see the glare was detected on front and back of a document
    ...
    Then I should see uploaded_image ()
    And error_message should include "errors.glare_detected.message"
    And error_instruction should include "errors.glare_detected.instruction"
