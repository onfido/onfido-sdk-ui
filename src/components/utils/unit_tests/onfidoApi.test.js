...
describe('sendMultiframeSelfie', () => {
  describe('with valid data', () => {
    it('should send two XHR requests', async() => {
      sendMultiframeSelfie(snapshotData, selfieData, jwtToken, url, onSuccess, onError, trackingCallback)
  ...
  describe('with invalid data', () => {
    ...
    it('should call onError callback with TypeError', () => {
      expect.assertions(1);
      sendMultiframeSelfie(invalidSnapshotData, invalidSelfieData, jwtToken, url, onSuccess, onError, trackingCallback)
    })
  })
})
