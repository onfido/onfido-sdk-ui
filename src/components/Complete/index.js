...
class Complete extends Component {
  ...
  fetchQrCode = () => {
    ...
    console.log('queryParams', this.state.queryParams)
    const data = {
      firstName,
      lastName,
      error,
