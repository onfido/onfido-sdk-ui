...
- Public: the tearDown method is now marked as deprecated. Prefer using safeTearDown instead, which is a promise and awaitable.
...
[next-version]: https://github.com/onfido/onfido-sdk-ui/compare/12.3.6...development
