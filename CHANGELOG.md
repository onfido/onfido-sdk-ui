...
- Internal: Upgraded several dev dependencies to fix critical and high risk npm security vulnerabilities. Some of the dependencies that were upgraded are `webpack`, which was upgraded from v4 to v5, several webpack plugins and `socket.io-client`.
