...
- Cross Device Stability Updates
...
- Fixed missing instruction message in Passive Liveness face alignment
- Fixed missing accessibility label in Passive Liveness and Randomness video frames
...
- Add support for QES in e-signature module
...
- Refactor the dynamic QR code logic to include signature verification.

### Fixed

- Fix colorBackgroundAlertInfo token not working.

### Changed

- Add an error screen when passkey application domain is misconfigured.

## [14.65.0] - 2026-02-20

### Changed

- Improve analytics in the Motion module
...
- Fix cobranding in footer

## [14.63.0] - 2026-02-04

### Fixed

- Fix crash in crossdevice when api call fails

### Changed

- Add error screens when Entra application client secret is expired
...
- Change default Verified Credential sandbox result to clear
