...
### Added
- Public: Glare detection feature for documents. Not available for documents in PDF format.

### Changed
- Public: Improved how errors and warnings are displayed on the UI.
- Public: Improved navigation between steps when using the browser navigation buttons.
